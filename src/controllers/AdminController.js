...
module.exports = {   
    async index (request, response) {
        const admins = await connection('admMovies').select('*');
    ...
    async signIn(request, response) {
        ...
        const admin = await connection('admMovies')
    ...
    async create(request, response) {
        ...
        const [admId] = await connection('admMovies').insert({
            admNome, 
            admSenha: senha, 
            admEmail,
            admNivAcesso
    ...
    async updPassword(request, response) {
        ...
        await connection('admMovies').where('admEmail', email)   
        .update({
            admSenha: senha,           
        });
